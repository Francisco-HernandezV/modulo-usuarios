...
const IconBookmark = () => <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>;
const IconCash = () => <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>;
...
const IconKey = () => <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/></svg>;

const NAV_ITEMS = [
  { path: "/admin",             label: "Dashboard",          icon: <IconHome />,     section: "GENERAL"   },
  { path: "/pos",               label: "Caja / POS",         icon: <IconPOS />,      section: "GENERAL" },
  { path: "/apartados",         label: "Apartados",          icon: <IconBookmark />, section: "GENERAL" },
  { path: "/caja",              label: "Corte de Caja",      icon: <IconCash />,     section: "GENERAL" },
