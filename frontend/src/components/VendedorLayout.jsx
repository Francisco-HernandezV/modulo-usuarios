...
const IconBookmark = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>;
...
const NAV_VENDEDOR = [
  ...
  { path: "/apartados",          label: "Apartados",      icon: <IconBookmark />, section: "OPERACIÓN" },
  { path: "/caja",               label: "Corte de Caja",  icon: <IconCash />,     section: "OPERACIÓN" },
...
export default function VendedorLayout({ children, pageTitle }) {
  ...
  // Cierra el sidebar móvil al cambiar de vista
  useEffect(() => {
    setMobileOpen(false);
  }, [location.pathname]);
  ...
  return (
    <div className={`adm-layout ${mobileOpen ? "sidebar-open" : ""}`}>
      <button
      ...
      <div className="adm-main">
        <header className="adm-topbar">
          <div className="adm-topbar-left">
            <button
              className="adm-menu-btn adm-menu-btn-mobile"
              type="button"
